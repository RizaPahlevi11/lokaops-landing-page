...
```bash
git remote add encore encore://lokaops-landing-page-r4w2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/lokaops-landing-page-r4w2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/lokaops-landing-page-r4w2/settings/integrations/github)
